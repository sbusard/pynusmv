/**CHeaderFile*****************************************************************
  ...
  FileName    [BDDCompleteTraceExecutor.h]

  PackageName [trace.exec]

  Synopsis    [Public interface of class 'BDDCompleteTraceExecutor']

  Description []

  SeeAlso     [BDDCompleteTraceExecutor.c]
...
#ifndef __BDD_COMPLETE_TRACE_EXECUTOR_H__
#define __BDD_COMPLETE_TRACE_EXECUTOR_H__
...
/**Type***********************************************************************
  ...
  Synopsis    [Definition of the public accessor for class BDDCompleteTraceExecutor]
...
/**Macros**********************************************************************
  ...
  Synopsis    [To cast and check instances of class BDDCompleteTraceExecutor]
...
EXTERN BDDCompleteTraceExecutor_ptr
BDDCompleteTraceExecutor_create ARGS((const BddFsm_ptr fsm,
...
#endif /* __BDD_COMPLETE_TRACE_EXECUTOR_H__ */
