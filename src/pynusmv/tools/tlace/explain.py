...
def countex(fsm, state, spec, context):
    ...
    if spec.type == parser.CONTEXT:
        ...
        newspec = Node.find_node(parser.TRUEEXP, None, None)
        ...
        newspec = Node.find_node(parser.AND,
                                 Node.find_node(parser.NOT, spec.car, None),
                                 Node.find_node(parser.NOT, spec.cdr, None))
        ...
        if spec.type == parser.NOT:
            ...
            newspec = Node.find_node(parser.NOT, spec, None)
