...
# ----------------------------------------------------------------------
# Copyright (C) by Geoff Richards <ctzgpr AT scs.leeds.ac.uk>
# Copying and distribution of this macro, with or without
...
AC_DEFINE_UNQUOTED(FUNCATTR_NORETURN, $FUNCATTR_NORETURN_VAL, [Define to __attribute((noreturn)) or empty if not available])
])dnl
